...
<div class="relative" x-data="passwordToggle()">
    ...
    <button type="button" @click="toggle()" :aria-label="show ? 'Hide password' : 'Show password'"
        ...
        <svg x-show="show" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="display:none" aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
